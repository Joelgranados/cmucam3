...
{
if(SBOT_SPOON_DIR<0) cc3_servo_set(2,SBOT_SPOON_MID-position);
	else cc3_servo_set(2,SBOT_SPOON_MID+position);
}

void spoonBot_left( int speed)
{
if(SBOT_LEFT_DIR>0) cc3_servo_set(0,SBOT_LEFT_MID-speed);
	else cc3_servo_set(0,SBOT_LEFT_MID+speed);
if(SBOT_RIGHT_DIR>0) cc3_servo_set(1,SBOT_RIGHT_MID+speed);
	else cc3_servo_set(1,SBOT_RIGHT_MID-speed);
}
...
void spoonBot_stop()
{
    cc3_servo_set(1,SBOT_RIGHT_MID);
    cc3_servo_set(0,SBOT_LEFT_MID);
    //cc3_servo_set(2,SBOT_SPOON_MID);
}
